      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            ...
            <a href="<?php echo base_url('petugas'); ?>">Liquid Laundry</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo base_url('petugas'); ?>"><img src="<?php echo base_url(); ?>assets/img/logo/icon.png" alt="logo" width="32" class="shadow-light rounded-circle"></a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">Data Pelanggan</li>
            <li class="dropdown">
              <a href="<?php echo base_url('petugas/pelanggan'); ?>"><i class="fas fa-users-cog"></i> <span>Data Pelanggan</span></a>
            </li>
