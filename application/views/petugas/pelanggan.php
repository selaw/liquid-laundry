    ...
    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 line" >
                            <div class="panel panel-default">
                                <div class="x_content">
                                    <br />
                                    <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left" action="<?= base_url('petugas/input_pelanggan'); ?>">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                 ...
                                 $newB = $tgl_keluar->format('d-m-Y'); ?>
                                            ...
                                            <td><?php echo $newB; ?></td>
                                            <td>
                                              <a class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit" href="<?= base_url('petugas/pelanggan_edit/');echo $p['id_pelanggan']; ?>"><i class="fas fa-pencil-alt"></i></a>
                                              <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="location.href='<?= base_url('petugas/hapus_pelanggan/');echo $p['id_pelanggan']; ?>';"><i class="fas fa-trash"></i></a>
                                               <a class="btn btn-warning btn-action mr-1" data-toggle="tooltip" title="Notifikasi" href="<?= base_url('petugas/pelanggan_nota/');echo $p['id_pelanggan']; ?>"><i class="fas fa-bell"></i></a>
                                               <a class="btn btn-success btn-action mr-1" data-toggle="tooltip" title="Whatsapp" href="<?= base_url('petugas/WA'); ?>"><i class="fas fa-phone"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
